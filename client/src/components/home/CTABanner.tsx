        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button 
              asChild
              variant="secondary"
              className="bg-white text-primary hover:bg-gray-100 py-4 px-8 rounded-lg text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
            ...
            <Button 
              asChild
              className="bg-secondary text-black hover:bg-secondary/90 py-4 px-8 rounded-lg text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
